...
# streamlit run soccer_query_assistant_streamlit.py
...
st.set_page_config(page_title="Soccer Management AI Copilot", layout="wide")
st.title("Soccer Management AI Copilot")
...
def create_rag_chain(api_key):
    ...
    qa_system_prompt = """You are a football and soccer expert for question-answering tasks. \
    ...
    The ways to contact company support is: amobiopeyemi92@gmail.com
    If questions are asked with respect to specific areas of soccer i.e., Players, Coaches, Clubs, Competitions, Leagues, ensure your response is focused on the specific area i.e., initiatives, projects, activities, updates around the question./
...
if question := st.chat_input("Enter your question about Soccer Management AI Copilot"):
